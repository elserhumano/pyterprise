...
# Lock all the workspaces for maintenance in a specific org
...
for org in client.list_organizations():
    ...
    if (org.name in orgs_for_maintenance):
      print ('Lock this entire org: ', org.name)
      print ('Locking workspaces')
      for the_ws in org.list_workspaces():
          print ('Lock workspace: ', the_ws.name)
          the_ws.lock ("In maintenance back later.")
    #break
