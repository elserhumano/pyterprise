...
for org in client.list_organizations():
    ...
    for varset in org.list_varsets():
        ...
        for variable_set in varset.list_set_variables():
            ...
            if (variable_set.key == "refresh_token" or variable_set.key == "vra_refresh_token") and org.name:
                ...
                for x in accounts_from_file:
                    ...
                    if get_the_account == the_account:
                        ...
                        varset.add_variable_to_set_ext(the_variable, the_token, the_desc, 'terraform', False, True)
                        print ('')
                        print ('.................................................')
                        print ('')
