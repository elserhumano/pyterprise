...
varset_to_add = 'GLOBAL_VAR_SET_FERFER'

variable_to_move = 'netbox_server_url'
value_to_move    = 'https://netbox-prod.medc.mycompany.intranet'
...
for varset in org.list_varsets():
    ...
    if varset_to_remove in varset.name and variable_to_move in dict_variables and 'FERFER' in varset.name:
        print ('')
